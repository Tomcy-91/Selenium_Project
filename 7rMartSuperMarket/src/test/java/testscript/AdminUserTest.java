...
public class AdminUserTest extends BaseClass {
	...
	public void verifyUserisAbletocreateNewAdminUser(String username, String password, String adminUsername,
			String adminPassword, String adminUserType) throws IOException {
