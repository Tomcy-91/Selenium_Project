...
public class SubCategoryPage {
	...
	WebElement subcategoryinfolink;
	@FindBy(xpath = "//a[@onclick='click_button(1)']")
	WebElement subcategory_newbutton;
	@FindBy(xpath = "//select[@name='cat_id']")
	WebElement category_dropdownvalue;
	@FindBy(xpath = "//input[@id='subcategory']")
	WebElement subcategoryfield_value;
	@FindBy(xpath = "//input[@name='main_img']")
	WebElement subcategory_choosefilebutton;
	@FindBy(xpath = "//button[text()='Save']")
	WebElement subcategory_savebutton;
